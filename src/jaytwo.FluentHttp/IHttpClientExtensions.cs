...
//            => httpClient.SendAsync(request, HttpCompletionOption.ResponseContentRead, CancellationToken.None);
...
//            => httpClient.SendAsync(request, HttpCompletionOption.ResponseContentRead, cancellationToken);
...
//        private static Task<HttpResponseMessage> SendAsync(IHttpClient httpClient, HttpMethod method, Action<HttpRequestMessage> requestBuilder)
//        {
